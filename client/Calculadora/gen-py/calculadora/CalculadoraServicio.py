...
class Client(Iface):
    ...
    def multiplicacion(self):
        self.send_multiplicacion()
        return self.recv_multiplicacion()

    def send_multiplicacion(self):
...
class Processor(Iface, TProcessor):
    ...
    def process_suma(self, seqid, iprot, oprot):
        ...
        result = suma_result()
        try:
            result.success = self._handler.suma()
    ...
    def process_resta(self, seqid, iprot, oprot):
        ...
        result = resta_result()
        try:
            result.success = self._handler.resta()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_multiplicacion(self, seqid, iprot, oprot):
        ...
        result = multiplicacion_result()
        try:
            result.success = self._handler.multiplicacion()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_division(self, seqid, iprot, oprot):
        ...
        result = division_result()
        try:
            result.success = self._handler.division()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
